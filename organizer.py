...
MODULE_KEYWORDS = [
    ...
    (["accounts payable", "payables", "invoice approval", "invoice processing",
      ...
      "invoice imaging", "integrated imaging",
      "oracle procurement", "fusion procurement"], None, "P2P"),
...
def extract_title(path: Path, module: str = "", version: str = "") -> str:
    ...
    if not title:
        stem = path.stem
        sep = r"[\s_]+"
        all_modules = r"(?:AP_PO|P2P|O2C|R2R|GL|COA|CVR|SLA|AHCS|FAH|FA|Security|CST|PA|eTax|HMRC|BIP.?Reports|FDI|FCCS|ARCS|PBCS|Unclassified|CX|ERP|HCM|SCM)"
